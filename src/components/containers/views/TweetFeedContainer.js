...
import Tweet from "../../panels/views/Tweet";
...
const TweetFeedContainer = () => {
  ...
  return (
    <TweetFeedPanel reconnectMessage={reconnectMessage} errorMessage={errorMessage} waitingMessage={waitingMessage} showTweets={showTweets} />
